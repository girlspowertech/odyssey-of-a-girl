...
const NavLink: FC<NavLinkProps> = ({ url, text, triangleClass, className = '' }) => (
  <Link to={ url } className={ `flex gap-3 mb-3 items-center ${ className }` }>
...
const Home = () => {
  return <div className="m-auto flex w-[80%] max-w-[1440px] justify-between sm:h-[80%] sm:mt-20 text-secondary flex-col sm:flex-row">
    <div className="mt-16 max-[480px]:mt-10 flex flex-col font-jeju sm:justify-between flex-[60%] flex-shrink-0 flex-grow-0">
      ...
      <div className="text-3xl flex flex-col ml-6 mb-10 gap-3">
        ...
        <NavLink url="/contribute" text="contribute" triangleClass="border-l-blue-500" />
      </div>
    </div>
